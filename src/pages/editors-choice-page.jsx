...
import { ArrowLeft, BookOpen, Star, ChevronLeft, ChevronRight } from "lucide-react";
                ...
                <div className="relative max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-20 py-12">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-lg text-blue-100 max-w-2xl mx-auto font-poppins">
                            Curated selections of the finest books, chosen by our editors
                        </p>
                        <div className="flex items-center justify-center gap-2 mt-6">
                            <BookOpen className="w-5 h-5 text-blue-200" />
                            <span className="text-blue-100 font-poppins">{booksArray.length} curated books</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-20 py-12">
                <div className="flex items-center justify-between mb-6">
                    <div className="text-sm text-gray-500">
                        <strong className="text-gray-900">{booksArray.length}</strong> books curated by our editors
                    </div>
                    <div className="text-sm text-gray-500">
